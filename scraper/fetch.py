...
DOC_TYPES = {
    ...
    "ALN": ("lien",            "HOA Lien"),
    "ADL": ("lien",            "Administrative Lien"),
}

GRANTEE_IS_OWNER = {"LC", "CSL", "FTL", "STL", "NLF", "JUD", "AJ", "ALN", "ADL", "HL"}
...
def build_output(raw_records: list, date_from: str, date_to: str) -> dict:
    ...
    return {
        ...
        "source":       "Dallas County TX – PublicSearch",
...
async def main():
    ...
    log.info("=== Dallas County TX Lead Scraper ===")
